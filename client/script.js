...
function init() {
  ...
  addRoom("Rust");
  changeRoom("lobby");
  addMessage("lobby", "NicoScript", "Hey! Open another browser tab, send a message.", true);
  addMessage("Rust", "NicoScript", "This is another room. Neat, huh?", true);
  ...
  newRoomForm.addEventListener("submit", (e) => {
    ...
    addMessage(room, "NicoScript", `Look, your own "${room}" room! Nice.`, true);
  })
